...
class NutritionalCalculatorVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func calculateCalaries() -> Any {
        ...
        if(grams == 0.0){
            ...
            let val2 = calcProteinsforFoods(inGrams: grams!, inCategory: category!)
            let val3 = calcCarbohydratesforFoods(inGrams: grams!, inCategory: category!)
            let val4 = calcTotalCalariesforFoods(inGrams: grams!, inCategory: category!)
